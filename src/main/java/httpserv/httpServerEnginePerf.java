...
public class httpServerEnginePerf implements Runnable{

	
	public static String ipAddress;
	
	public httpServerEnginePerf() throws IOException, InterruptedException
	{
    ...
    private static URI getBaseURI() {
    	...
    	*/
    	...
    	return UriBuilder.fromUri("http://0.0.0.0/").port(getPort(32002)).build();
