...
public class TopologyEngine implements Runnable {

	private String resource_id = "netdiscovery_resource";
	private String inode_id = "netdiscovery_inode";
	...
	public void run() 
	{
		try
		{
			ControllerEngine.TopologyActive = true;
			while (ControllerEngine.TopologyActive) 
			{
				try
				{
					//getIsAssignedEdgeId(String resource_id, String inode_id)
					//List<String> getIsAssignedEdgeIds(String resource_id, String inode_id)
					//public String getIsAssignedParam(String edge_id,String param_name)
					List<String> edge_list = ControllerEngine.gdb.getIsAssignedEdgeIds(resource_id, inode_id);
